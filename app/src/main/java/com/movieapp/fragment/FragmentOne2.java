...
public class FragmentOne2 extends Fragment implements ViewPager.OnPageChangeListener{

    private ConvenientBanner convenientBanner;
    private List<Integer> localImages = new ArrayList<Integer>();
    private List<String> localDescribes = new ArrayList<String>();
...
//        mRecyclerView.setLayoutManager(new StaggeredGridLayoutManager(2, OrientationHelper.VERTICAL));
    ...
    private void init(){
        ...
        mAdapter= new CommonAdapter<String>(getActivity().getApplicationContext(), R.layout.item_list, mDatas){
