package com.movieapp.view.vitamio;
...
import com.movieapp.utils.BitmapUtil;
import com.movieapp.utils.RandomUtil;
    ...
    protected void initOtherView() {
        ...
        mediacontroller_snapshot.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(saveSuccess){
                    Toast.makeText(activity, "截屏保存到" + picturnPath, Toast.LENGTH_SHORT).show();
                }else{
        ...
        mediacontroller_screen_fit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(activity, strDialogs[mCurrentPageSize], Toast.LENGTH_SHORT).show();
